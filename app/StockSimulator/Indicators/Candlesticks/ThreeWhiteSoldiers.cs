...
namespace StockSimulator.Indicators
{
	...
	/// </summary>
	class ThreeWhiteSoldiers : BaseCandlestick
	{
		...
		protected override void OnBarUpdate(int currentBar)
		{
			...
			if (currentBar < 2 || (Simulator.Config.TrendStrength > 0 && trend.UpTrend[currentBar] == true))
			{
				return;
			}
			...
			if (Found[currentBar - 1] == false && Found[currentBar - 2] == false &&
				...
				Data.Open[currentBar - 1] < Data.Close[currentBar - 2] && Data.Open[currentBar - 1] > Data.Open[currentBar - 2])
			{
