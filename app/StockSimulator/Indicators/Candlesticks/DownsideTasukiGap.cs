...
namespace StockSimulator.Indicators
{
	...
	/// Downside Tasuki Gap
	/// </summary>
	class DownsideTasukiGap : BaseCandlestick
	{
		public DownsideTasukiGap(TickerData tickerData, RunnableFactory factory)
		...
		protected override void OnBarUpdate(int currentBar)
		{
			...
			if (Data.Close[currentBar - 2] < Data.Open[currentBar - 2] && Data.Close[currentBar - 1] < Data.Open[currentBar - 1] && Data.Close[currentBar] > Data.Open[currentBar]
				&& Data.High[currentBar - 1] < Data.Low[currentBar - 2]
