...
namespace StockSimulator.Indicators
{
	...
	/// Hammer
	/// </summary>
	class Hammer : BaseCandlestick
	{
		public Hammer(TickerData tickerData, RunnableFactory factory)
		...
		protected override void OnBarUpdate(int currentBar)
		{
			...
			{
				if (trend.UpTrend[currentBar] == true || UtilityMethods.Min(Data.Low, currentBar, Simulator.Config.TrendStrength) != Data.Low[currentBar])
				{
					return;
				}
			}
