...
namespace StockSimulator.Indicators
{
	...
	/// </summary>
	class RisingThreeMethods : BaseCandlestick
	{
		public RisingThreeMethods(TickerData tickerData, RunnableFactory factory)
		...
		protected override void OnBarUpdate(int currentBar)
		{
			...
			if (Data.Close[currentBar - 4] > Data.Open[currentBar - 4] && Data.Close[currentBar] > Data.Open[currentBar] && Data.Close[currentBar] > Data.High[currentBar - 4] &&
