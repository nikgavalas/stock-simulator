...
{
	class BearStochasticsCrossoverPredicted : Strategy
	{
		public BearStochasticsCrossoverPredicted(TickerData tickerData, RunnableFactory factory)
		...
		{
			return "BearStochasticsCrossoverPredicted";
		}
