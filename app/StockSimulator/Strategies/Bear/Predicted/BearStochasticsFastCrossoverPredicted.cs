...
{
	class BearStochasticsFastCrossoverPredicted : Strategy
	{
		public BearStochasticsFastCrossoverPredicted(TickerData tickerData, RunnableFactory factory)
		...
		{
			return "BearStochasticsFastCrossoverPredicted";
		}
